...
@Component({
  ...
  templateUrl: './formateur-notes.component.html',
  styleUrls: ['./formateur-notes.component.scss']
})
export class FormateurNotesComponent implements OnInit {
  ...
  goToNotes(seanceId: number): void {
